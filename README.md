...
The proof CLI also rejects duplicate object members, Python's non-standard
`NaN`/`Infinity` constants, and integers outside the cross-runtime exact range
`[-(2^53-1), 2^53-1]` before canonicalization, avoiding parser-dependent
